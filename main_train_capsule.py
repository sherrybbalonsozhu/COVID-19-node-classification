...
from data_plot import plot_scatter,plot_feature,liao_feat_names
import logging
...
def main(args):
    ...
    if args.do_train:
        ...
        plot_feature(model,nheads=args.nHeads,n_hidden=args.hidden_dim,featnames=liao_feat_names)
